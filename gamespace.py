...
## assets folder
img_dir = path.join(path.dirname(__file__), 'game_pic')
sound_folder = path.join(path.dirname(__file__), 'game_sounds')
...
background = pygame.image.load(path.join(img_dir, 'c.png')).convert()
